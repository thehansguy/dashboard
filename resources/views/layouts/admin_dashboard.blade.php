...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>Admin Dashboard | Simpliexpand</title>
					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container">
							...
							<div class="d-none d-lg-flex align-items-center mr-3">
								<!--begin::Logo-->
								<a href="{{route('client_dashboard')}}">
									<img alt="Logo" src="{{asset('images/logo.png')}}" class="logo-default max-h-65px"  />
								</a>
								<!--end::Logo-->
							</div>
							<!--end::Left-->
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
										...
										<div class="navi navi-spacer-x-0 pt-5">
											...
											<div class="navi-footer px-8 py-5">
												<a href="{{ route('logout') }}" method="post"  class="btn btn-light-primary font-weight-bold">Sign Out</a>
