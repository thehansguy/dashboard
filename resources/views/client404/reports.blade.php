                                    ...
                                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" style="height: 250px; ">
                                        <div class="card-body d-flex">
                                            <div class="d-flex py-5 flex-column align-items-start flex-grow-1">
                                                ...
                                                <a href='#' class="btn btn-link btn-link-white font-weight-bold">Download Report     
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: auto; background-image:">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <a href='#' class="text-dark-75 text-hover-primary font-weight-bolder font-size-h3">Ideal Customer</a>
                                          
                                        </div>
                                        <!--end::Body-->
                                        <div class="bg-auto bg-contain">
                                            <img src="{{asset('images/dashboard/ideal_customer_1.png')}}" alt="image goes here" width="100%">
