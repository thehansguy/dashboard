                            ...
                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" >
                                ...
                                <div class="col-xl-12 card card-custom bgi-no-repeat bgi-size-cover gutter-b bg-primary" style="height: auto; )}}">
                                    ...
                                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: auto; background-image: ">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <a href='#' class="text-dark-75 text-hover-primary font-weight-bolder font-size-h3">Payments</a>
                                        ...
                                        <div class="card-body d-flex flex-column p-0">
                                            ...
                                            <div class="flex-grow-1 card-spacer pb-0">
                                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                    <div class="mr-2">
                                                        <a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-h2">Website Overview</a>
                                                ...
                                                <div class="bg-auto bg-contain" >
                                                    <img src="{{asset('images/dashboard/audience_overview.png')}}" alt="image goes here" width="100%">                                                    
                                                </div>
                                            </div>
                                            <!--end::Stats-->
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="flex-grow-1 pb-5">
                                        ...
                                        <a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-h4">Our Latest Package
                                        <!--begin::Team-->
                                        <div class="d-flex align-items-center">
                                            <img src="{{asset('images/dashboard/our_latest_package.png')}}" alt="image goes here" width="100%">                                        
                                        </div>
                                        <!--end::Team-->
                                    </div>
