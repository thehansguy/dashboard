                                    ...
                                    <div class="card-spacer bg-white card-rounded flex-grow-1">
                                        ...
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                ...
                                                <div class="font-size-h2 font-weight-bolder">{{ $audience_data->accounts_reached }}</div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">Content Interraction</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $audience_data->content_interaction }}</div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Row-->
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                ...
                                                <div class="font-size-h2 font-weight-bolder">{{ $audience_data->total_followers }}</div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">Likes</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $audience_data->likes }}</div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column p-0">
                                    ...
                                    <div class="flex-grow-1 card-spacer pb-0">
                                        ...
                                        <div class="bg-auto bg-contain" >
											<img src="{{ asset('images/dashboard/linegraph.jpg')}}"  alt="{{ asset('images/dashboard/linegraph.jpg')  }}" width="100%"/>
                                        </div>
                                    </div>
                                    <!--end::Stats-->
                                ...
                                <div class="card-body d-flex">
                                    <div class="d-flex py-5 flex-column align-items-start flex-grow-1">
                                        <div class="flex-grow-1">
                                            <a href="{{ asset($audience_data->top_locations_image_path.$audience_data->top_locations_image)  }}" target="_blank" class="text-white font-weight-bolder font-size-h3">Top Locations</a>                                            
                                            <div class="bg-auto bg-contain" >
<<<<<<< HEAD
                                                <a href="{{ asset($audience_data->top_locations_image_path.$audience_data->top_locations_image)  }}" target="_blank" rel="noopener noreferrer">
                                                    <img src="{{ asset($audience_data->top_locations_image_path.$audience_data->top_locations_image)  }}"  alt="{{ asset($audience_data->top_locations_image_path.$audience_data->top_locations_image)}}" width="100%">                                                    
                                                </a>
=======
                                                <img src="{{ asset($audience_data->top_locations_image_path.$audience_data->top_locations_image)  }}"  alt="{{ asset($audience_data->top_locations_image_path.$audience_data->top_locations_image)}}" width="100%">                                                    
>>>>>>> finesse_ui
                            ...
                            <div class="card card-custom gutter-b" style="height: auto">
                                ...
                                <div class="bg-auto bg-contain" >
                                    <a href="{{ asset($audience_data->age_range_image_path.$audience_data->age_range_image) }}" target="_blank" rel="noopener noreferrer">
                                        <img src="{{ asset($audience_data->age_range_image_path.$audience_data->age_range_image) }}"  alt="{{ asset($audience_data->age_range_image_path.$audience_data->age_range_image) }}" width="100%">                                                    
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: auto; ">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <a href='{{ asset($audience_data->gender_image_path.$audience_data->gender_image)}}' target="_blank" class="text-dark-75 text-hover-primary font-weight-bolder font-size-h3">Gender</a>
                                     <div class="bg-auto bg-contain" >
                                        <a href="{{ asset($audience_data->gender_image_path.$audience_data->gender_image)}}" target="_blank" rel="noopener noreferrer">
                                            <img src="{{ asset($audience_data->gender_image_path.$audience_data->gender_image)}}"  alt="{{ asset($audience_data->gender_image_path.$audience_data->gender_image)}}" width="100%">                                                    
                                        </a>
                        ...
                        {{-- <div class="col-xl-4">
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="bg-auto bg-contain">
                                        <img src="{{ asset($audience_data->pie_chart_image_path.$audience_data->pie_chart_image)}}"  alt="{{ asset($audience_data->pie_chart_image_path.$audience_data->pie_chart_image)}}" width="100%">                                                    
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card card-custom card-stretch gutter-b">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="flex-grow-1 pb-5">               
                                        <a href="{{ asset($audience_data->histogram_image_path.$audience_data->histogram_image)}}" class="text-dark font-weight-bolder text-hover-primary font-size-h4">Histogram                           
                                    </div>
                                ...
                                <div class="bg-auto bg-contain">
                                    <a href="{{ asset($audience_data->histogram_image_path.$audience_data->histogram_image)}}" target="_blank" rel="noopener noreferrer">
                                        <img src="{{ asset($audience_data->histogram_image_path.$audience_data->histogram_image)}}"  alt="{{ asset($audience_data->histogram_image_path.$audience_data->histogram_image)}}" width="100%">                                                    
