                            ...
                            <div class="d-flex align-items-baseline flex-wrap mr-5">
                                ...
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('client_dashboard') }}" class="text-muted">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('client_audience') }}" class="text-muted">Audience</a>
                                    </li>
                    ...
                    <div class="row">
                        {{-- <div class="col-xl-4">
                            ...
                            <div class="card card-custom bg-radial-gradient-danger gutter-b card-stretch">
                                ...
                                <div class="card-header border-0 py-5" >
                                    <h3 class="card-title font-weight-bolder text-white">SWOT for {{ $users_data->name}}</h3>                     
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                    ...
                                    <div class="card-spacer bg-white card-rounded flex-grow-1">
                                        ...
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                ...
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->accounts_reached }}</div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">Content Interraction</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->interaction }}</div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Row-->
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                ...
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->total_followers }}</div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">Likes</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->likes }}</div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                    </div>
                        ...
                        {{-- <div class="col-xl-4">
                            ...
                            <div class="card card-custom bg-radial-gradient-danger gutter-b card-stretch">
                                <!--begin::Header-->
                                <div class="card-header border-0 py-5">
                                    <h3 class="card-title font-weight-bolder text-white">Competitor's SWOT</h3>                            
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="card-body d-flex flex-column p-0">
                                    ...
                                    <div class="card-spacer bg-white card-rounded flex-grow-1">
                                        ...
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                <div class="font-size-sm text-muted font-weight-bold">Accounts Reached</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->competitor_accounts_reached }}</div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">Content Interraction</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->competitor_interaction }}</div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                        <!--begin::Row-->
                                        <div class="row m-0">
                                            <div class="col px-8 py-6 mr-8">
                                                <div class="font-size-sm text-muted font-weight-bold">Total Followers</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->competitor_total_followers }}</div>
                                            </div>
                                            <div class="col px-8 py-6">
                                                <div class="font-size-sm text-muted font-weight-bold">Likes</div>
                                                <div class="font-size-h2 font-weight-bolder">{{ $market_analysis_data->competiter_likes }}</div>
                                            </div>
                                        </div>
                                        <!--end::Row-->
                                    </div>
                            ...
                            <div class="card card-custom gutter-b" style="height: 250px">
                                ...
                                <div class="card-body d-flex flex-column p-0">
                                    ...
                                    <div class="flex-grow-1 card-spacer pb-0">
                                        ...
                                        <div class="font-weight-boldest font-size-h3 pt-2">Market Size</div>
                                    ...
                                    <div class="bg-auto bg-contain">
                                        <a href="{{ asset($market_analysis_data->market_size_chart_image_path.$market_analysis_data->market_size_chart_image)}}" target="_blank" rel="noopener noreferrer">
                                            <img src="{{ asset($market_analysis_data->market_size_chart_image_path.$market_analysis_data->market_size_chart_image)}}"  alt="{{ asset($market_analysis_data->top_locations_image_path.$market_analysis_data->top_locations_image)}}" width="100%">                                                    
                            ...
                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: auto; ">
                                ...
                                <div class="bg-auto bg-contain">
                                    <a href="{{ asset($audience_data->gender_image_path.$audience_data->gender_image)}}" target="_blank" rel="noopener noreferrer">
                                        <img src="{{ asset($audience_data->gender_image_path.$audience_data->gender_image)}}"  alt="{{ asset($market_analysis_data->top_locations_image_path.$market_analysis_data->top_locations_image)}}" width="100%">                                                    
                                    </a>
                                </div>
                                <!--end::Body-->
                            </div>
