										...
										<div class="card card-custom gutter-b card-stretch">
											...
											<div class="card-header border-0 py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">General blog</span>
													{{-- <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 400+ new members</span> --}}
												</h3>
												<div class="card-toolbar">
													<a href="{{route('admin_blogs.create')}}" class="btn btn-success font-weight-bolder font-size-sm">
													...
													<table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_3">
														<thead>
															<tr class="text-left text-uppercase">
																...
																<th class="min-width: 120px" >Blog Thumbnail Image</th>
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$blog->user->name}}</span>
																</td>
                                                                <td>
                                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                                                        <a href="{{ asset($blog->blog_image_path.$blog->blog_image)}}" target="_blank">
                                                                            {{$blog->blog_image}}
                                                                        </a>
                                                                    </span>
                                                                </td>
                                                                <td>
																	<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$blog->created_at->diffForHumans()}}</span>
																	<span class="text-muted font-weight-bold"></span>
																</td>
																<td class="text-left pr-0">
                                                                    <form action="{{ route('admin_blogs.destroy',$blog->id) }}" method="POST">
														
																		<a href="{{ route('admin_blogs.edit',$blog->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
