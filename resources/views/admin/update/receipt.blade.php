                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Edit Receipt Details</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Edit the Receipt Details Below</span>
                                            </h3>
                                        
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_receipts.update',$receipt_data->id) }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                {{-- <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="date_issued" class="not-sr-only">date_issued</label>
                                                    <input type="text" name="date_issued" id="date_issued" placeholder="date_issued"
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    ...
                                                    <input type="file" name="receipt_download_file" placeholder="Histogram file" id="receipt_download_file">
                                                        @error('receipt_download_file')
