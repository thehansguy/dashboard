										...
										<div class="card card-custom gutter-b card-stretch w-ful">
											...
											<div class="card-header border-0 py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Update Portal Users</span>
													<span class="text-muted mt-3 font-weight-bold font-size-sm">Update the Users details below</span>
												</h3>
										    ...
										    <form action="{{ route('users.update') }}" method="post" enctype="multipart/form-data" class="w-100 max-w-xs">
                                                @csrf
                                                @method('PUT')
