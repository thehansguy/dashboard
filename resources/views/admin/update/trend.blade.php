                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
                            <a href="{{ route('admin_trends.index') }}"  class="menu-link">
                                <span class="menu-text">trends Data</span>
                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Edit Trends Data</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Edit the Trends details below</span>
                                            </h3>
                                        
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_trends.update',$trend_data->id) }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="monday" class="not-sr-only">monday</label>
                                                    <input type="text" name="monday" id="monday" placeholder="monday"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('monday')
                                                        border-red-500
                                                    @enderror" value="{{ old('monday')}}">
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="tuesday" class="not-sr-only">tuesday</label>
                                                    <input type="text" name="tuesday" id="tuesday" placeholder="tuesday"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('tuesday')
                                                        border-red-500
                                                    @enderror" value="{{ old('tuesday')}}">
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="thursday" class="not-sr-only">thursday</label>
                                                    <input type="text" name="thursday" id="thursday" placeholder="thursday"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('thursday')
                                                        border-red-500
                                                    @enderror" value="{{ old('thursday')}}">
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="friday" class="not-sr-only">friday</label>
                                                    <input type="text" name="friday" id="friday" placeholder="friday"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('friday')
                                                        border-red-500
                                                    @enderror" value="{{ old('friday')}}">
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="saturday" class="not-sr-only">saturday</label>
                                                    <input type="text" name="saturday" id="saturday" placeholder="saturday"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('saturday')
                                                        border-red-500
                                                    @enderror" value="{{ old('saturday')}}">
