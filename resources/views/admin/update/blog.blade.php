                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Edit Blog Details</span>
                                        ...
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_blogs.update',$blog_data->id) }}" method="POST" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <div>Blog Image</div>
                                                    <input type="file" name="blog_image" placeholder="Gender Insights file" id="blog_image">
                                                        @error('blog_image')
