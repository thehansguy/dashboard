										...
										<div class="card card-custom gutter-b card-stretch w-ful">
											...
											<div class="card-header border-0 py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Edit Report Data</span>
													<span class="text-muted mt-3 font-weight-bold font-size-sm">Edit the Report details below</span>
												</h3>
                                            ...
                                            <!--begin::Body-->                                   
                                                <form action="{{ route('admin_reports.update',$report_data->id) }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                
                                                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                        <label for="user_id" class="not-sr-only">User Id</label>
                                                    ...
                                                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                        <div>Market Report File</div>
                                                        <input type="file" name="market_report_download_file" placeholder="Histogram file" id="market_report_download_file">
                                                            @error('market_report_download_file')
                                                    ...
                                                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                        <label for="month" class="not-sr-only">Enter the Month </label>
                                                        <input type="text" name="month" id="month" placeholder="Enter the Month"
                                                    ...
                                                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                        <div>Monthly Report File</div>
                                                        <input type="file" name="monthly_report_download_file" placeholder="Histogram file" id="monthly_report_download_file">
                                                            @error('monthly_report_download_file')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                                            @enderror
                                                    </div> <br><br><br>
                                                    ...
                                                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                        <div>Post Boosting Insights Chart - Image File</div>
                                                        <input type="file" name="post_boosting_insights_chart_image" placeholder="Histogram file" id="post_boosting_insights_chart_image">
                                                            @error('post_boosting_insights_chart_image')
                                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                                            @enderror
                                                    </div>
                                                    ...
                                                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                        <div>Ideal Customer - Image File</div>
                                                        <input type="file" name="ideal_customer_image" placeholder="Histogram file" id="ideal_customer_image">
