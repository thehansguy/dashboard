                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
                            <a href="{{ route('admin_invoices.index') }}"  class="menu-link">
                                <span class="menu-text">invoice Data</span>
                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Edit Invoice Details</span>
                                        ...
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_invoices.update',$invoice_data->id) }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
...
{{-- 
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    ...
                                                    <input type="file" name="invoice_download_file" placeholder="Histogram file" id="invoice_download_file">
                                                        @error('invoice_download_file')
