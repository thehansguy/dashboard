                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Edit Payment Details</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Edit the Payment details below</span>
                                            </h3>
                                        ...
                                        <!--begin::Body-->                                   
                                            <form action="{{ route('admin_payments.update',$payment_data->id) }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="payment_status" class="not-sr-only">payment_status</label>
                                                    <input type="text" name="payment_status" id="payment_status" placeholder="payment_status"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('payment_status')
                                                        border-red-500
                                                    @enderror" value="{{ old('payment_status')}}">
