                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Edit Website Overview Data</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Edit the Website Overview details below</span>
                                            </h3>
                                        
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_website_overviews.update',$website_overview_data->id) }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <div>Website Overview Image</div>
                                                    <input type="file" name="website_overview_image" placeholder="Histogram file" id="website_overview_image">
                                                        @error('website_overview_image')
