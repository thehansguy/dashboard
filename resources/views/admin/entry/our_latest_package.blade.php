                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
                            <a href="{{ route('admin_our_latest_packages.index') }}"  class="menu-link">
                                <span class="menu-text">our_latest_package Data</span>
                    ...
                    <div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-1">
                            ...
                            <div class="d-flex align-items-baseline flex-wrap mr-5">
                                <!--begin::Page Title-->
                                <h5 class="text-dark font-weight-bold my-1 mr-5">our_latest_package</h5>
                                <!--end::Page Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="" class="text-muted">our_latest_package</a>
                                    </li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Add New our_latest_package Data</span>
                                        ...
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_our_latest_packages.store') }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    ...
                                                    <label for="our_latest_package_image" class="sr-only">Our Latest Package Image</label>
                                                    <input type="text" name="our_latest_package_image" id="our_latest_package_image" placeholder="Enter Latest Package Image"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('our_latest_package_image')
                                                        border-red-500
                                                    @enderror" value="{{ old('our_latest_package_image')}}">
                                                    
                                                    @error('our_latest_package_image')
                                                        <div class="text-red-500 mt-2 text-sm">
                                                            {{$message}}
                                                        </div>
                                                    @enderror
