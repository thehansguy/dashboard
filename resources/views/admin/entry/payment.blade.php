                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Add New Payment Data</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Enter the new payment details below</span>
                                            </h3>
                                        ...
                                        <!--begin::Body-->                                   
                                            <form action="{{ route('admin_payments.store') }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    ...
                                                    <input type="text" name="payment_status" id="payment_status" placeholder="Enter Payment Status"
