                ...
                <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default header-menu-root-arrow">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
                            <a href="{{ route('admin_receipts.index') }}"  class="menu-link">
                                <span class="menu-text">receipt Data</span>
                    ...
                    <div class="w-100 d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-1">
                            ...
                            <div class="d-flex align-items-baseline flex-wrap mr-5">
                                <!--begin::Page Title-->
                                <h5 class="text-dark font-weight-bold my-1 mr-5">receipt</h5>
                                <!--end::Page Title-->
                                <!--begin::Breadcrumb-->
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="" class="text-muted">receipt</a>
                                    </li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                                    ...
                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Add New receipt</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">Enter the new invcoie data below</span>
                                            </h3>
                                        
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->                                    
                                            <form action="{{ route('admin_receipts.store') }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    <label for="date_issued" class="sr-only">Date Issued</label>
                                                    <input type="text" name="date_issued" id="date_issued" placeholder="Enter Date Issued"

                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('date_issued')
                                                        border-red-500
                                                    @enderror" value="{{ old('date_issued')}}">
                                                ...
                                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                    ...
                                                    <label for="download" class="sr-only">Download</label>
                                                    <input type="text" name="download" id="download" placeholder="Download"
                                                    class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('download')
                                                        border-red-500
                                                    @enderror" value="{{ old('download')}}">
