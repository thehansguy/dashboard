                                                    ...
                                                    <div class="card card-custom gutter-b card-stretch w-ful">
                                                        ...
                                                        <div class="card-header border-0 py-5">
                                                            <h3 class="card-title align-items-start flex-column">
                                                                <span class="card-label font-weight-bolder text-dark">Add New Market Analysis Data</span>
                                                        ...
                                                        <!--end::Header-->
                                                        <!--begin::Body-->                                   
                                                        <form action="{{ route('admin_market_analysis.store') }}" method="post" class="w-100 max-w-xs" enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <input type="text" name="accounts_reached" id="accounts_reached" placeholder="Enter Accounts Rreached"
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <label for="interaction" class="sr-only">Interactions</label>
                                                                <input type="text" name="interaction" id="" placeholder="Enter Interactions"

                                                                class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('interaction')
                                                                    border-red-500
                                                                @enderror" value="{{ old('interaction')}}">
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <input type="text" name="likes" id="likes" placeholder="Enter Likes"
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <label for="competitor_accounts_reached" class="sr-only">Competitor Accounts Reached</label>
                                                                <input type="text" name="competitor_accounts_reached" id="competitor_accounts_reached" placeholder="Enter Competitor Accounts Reached"

                                                                class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('competitor_accounts_reached')
                                                                    border-red-500
                                                                @enderror" value="{{ old('competitor_accounts_reached')}}">
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <label for="competitor_interaction" class="sr-only">Competitor Interaction</label>
                                                                <input type="text" name="competitor_interaction" id="competitor_interaction" placeholder="Enter Competitor Interaction"

                                                                class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('competitor_interaction')
                                                                    border-red-500
                                                                @enderror" value="{{ old('competitor_interaction')}}">
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <label for="competitor_total_followers" class="sr-only">Competitor Total Followers</label>
                                                                <input type="text" name="competitor_total_followers" id="competitor_total_followers" placeholder="Enter Competitor Total Followers"

                                                                class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('competitor_total_followers')
                                                                    border-red-500
                                                                @enderror" value="{{ old('competitor_total_followers')}}">
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <label for="competiter_likes" class="sr-only">Competitor Likes</label>
                                                                <input type="text" name="competiter_likes" id="competiter_likes" placeholder="Enter Competitor Likes"

                                                                class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('competiter_likes')
                                                                    border-red-500
                                                                @enderror" value="{{ old('competiter_likes')}}">
                                                            ...
                                                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-2">
                                                                ...
                                                                <label for="market_size_chart" class="sr-only">Market Size Chart</label>
                                                                <input type="text" name="market_size_chart" id="market_size_chart" placeholder="Enter Market Size Chart"
                                                                class="bg-gray-100 border-2 w-100 p-4 rounded-lg @error('market_size_chart')
                                                                    border-red-500
                                                                @enderror" value="{{ old('market_size_chart')}}">
