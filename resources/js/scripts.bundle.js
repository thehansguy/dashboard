...
KTUtil.ready((function() {
    ...
    "undefined" != typeof KTLayoutBrand && KTLayoutBrand.init("kt_brand"),
    void 0 !== KTLayoutAside && KTLayoutAside.init("kt_aside"),
    "undefined" != typeof KTLayoutAsideToggle && KTLayoutAsideToggle.init("kt_aside_toggle"),
...
var KTLayoutAsideMenu = function() {
    ...
    return {
        init: function(a) {
            ...
            KTUtil.isBreakpointDown("lg") && "1" === KTUtil.attr(t, "data-menu-scroll") && (n = {
                rememberPosition: !0,
                height: function() {
...
var KTLayoutAside = function() {
    ...
    return {
        init: function(a) {
            ...
            (t = KTUtil.getById(a),
            KTUtil.getBody(),
            t) && (n = KTUtil.hasClass(t, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside",
            e = new KTOffcanvas(t,{
                baseClass: n,
                overlay: !0,
